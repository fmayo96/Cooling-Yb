...
def Steady_state(T, j_0_3, j_0_4):
    ...
    M[6,6],M[6,8],M[6,11] = -0.5*(gamma_mn_2+gamma_mn_3+gamma_pl_3),1j*Omega_4,-1j*Omega_3
    M[7,7],M[7,9],M[7,10] = -0.5*(gamma_mn_2+gamma_mn_3+gamma_pl_3),-1j*Omega_4,1j*Omega_3
    M[8,2],M[8,4],M[8,6],M[8,8] = 1j*Omega_3,-1j*Omega_3,1j*Omega_4,-0.5*(gamma_mn_2+gamma_pl_3+gamma_pl_5)
    M[9,2],M[9,4],M[9,7],M[9,9] = -1j*Omega_3,1j*Omega_3,-1j*Omega_4,-0.5*(gamma_mn_2+gamma_pl_3+gamma_pl_5)
    M[10,3],M[10,4],M[10,7],M[10,10] = 1j*Omega_4,-1j*Omega_4,1j*Omega_3,-0.5*(gamma_mn_3-gamma_pl_5)
    M[11,3],M[11,4],M[11,6],M[11,11] = -1j*Omega_4,1j*Omega_4,-1j*Omega_3,-0.5*(gamma_mn_3-gamma_pl_5)
