...
rho_00 = np.loadtxt('150K/ss_j0=00_150.txt')
rho_01 = np.loadtxt('150K/ss_j0=01_150.txt')
rho_02 = np.loadtxt('150K/ss_j0=02_150.txt')
rho_03 = np.loadtxt('150K/ss_j0=03_150.txt')
rho_04 = np.loadtxt('150K/ss_j0=04_150.txt')
rho_05 = np.loadtxt('150K/ss_j0=05_150.txt')
rho_06 = np.loadtxt('150K/ss_j0=06_150.txt')
rho_07 = np.loadtxt('150K/ss_j0=07_150.txt')
rho_08 = np.loadtxt('150K/ss_j0=08_150.txt')
rho_09 = np.loadtxt('150K/ss_j0=09_150.txt')
rho_10 = np.loadtxt('150K/ss_j0=10_150.txt')
rho_11 = np.loadtxt('150K/ss_j0=11_150.txt')
rho_12 = np.loadtxt('150K/ss_j0=12_150.txt')
rho_13 = np.loadtxt('150K/ss_j0=13_150.txt')
rho_14 = np.loadtxt('150K/ss_j0=14_150.txt')
rho_15 = np.loadtxt('150K/ss_j0=15_150.txt')

rho_secondlaser_00 = np.loadtxt('150K_secondlaser/ss_j0=00_150.txt')
rho_secondlaser_01 = np.loadtxt('150K_secondlaser/ss_j0=01_150.txt')
rho_secondlaser_02 = np.loadtxt('150K_secondlaser/ss_j0=02_150.txt')
rho_secondlaser_03 = np.loadtxt('150K_secondlaser/ss_j0=03_150.txt')
rho_secondlaser_04 = np.loadtxt('150K_secondlaser/ss_j0=04_150.txt')
rho_secondlaser_05 = np.loadtxt('150K_secondlaser/ss_j0=05_150.txt')
rho_secondlaser_06 = np.loadtxt('150K_secondlaser/ss_j0=06_150.txt')
rho_secondlaser_07 = np.loadtxt('150K_secondlaser/ss_j0=07_150.txt')
rho_secondlaser_08 = np.loadtxt('150K_secondlaser/ss_j0=08_150.txt')
rho_secondlaser_09 = np.loadtxt('150K_secondlaser/ss_j0=09_150.txt')
rho_secondlaser_10 = np.loadtxt('150K_secondlaser/ss_j0=10_150.txt')
rho_secondlaser_11 = np.loadtxt('150K_secondlaser/ss_j0=11_150.txt')
rho_secondlaser_12 = np.loadtxt('150K_secondlaser/ss_j0=12_150.txt')
rho_secondlaser_13 = np.loadtxt('150K_secondlaser/ss_j0=13_150.txt')
rho_secondlaser_14 = np.loadtxt('150K_secondlaser/ss_j0=14_150.txt')
rho_secondlaser_15 = np.loadtxt('150K_secondlaser/ss_j0=15_150.txt')
